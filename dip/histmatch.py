...
equalized_ref_img = clahe.apply(img_bright)

# Get the histogram of the input and reference images
hist_input = cv2.calcHist([img_dark], [0], None, [256], [0,256])
...
matched_img = cv2.LUT(img_dark, mapping)
...
plt.subplot(1,3,2)
plt.imshow(equalized_ref_img, cmap='gray')
